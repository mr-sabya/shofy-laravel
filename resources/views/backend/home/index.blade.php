                ...
                <div class="card-body p-0">
                    <div class="category-slider no-arrow">
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/vegetable.svg') }}" class="img-fluid" alt="">
                                </a>
                        ...
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/cup.svg') }}" class="img-fluid" alt="">
                                </a>
                                <a href="javascript:void(0)" class="category-name">
                                    <h6>Beverages</h6>
                                </a>
                        ...
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/meats.svg') }}" class="img-fluid" alt="">
                                </a>
                                <a href="javascript:void(0)" class="category-name">
                                    <h6>Meats & Seafood</h6>
                                </a>
                        ...
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/breakfast.svg') }}" class="img-fluid" alt="">
                                </a>
                                <a href="javascript:void(0)" class="category-name">
                                    <h6>Breakfast</h6>
                                </a>
                        ...
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/frozen.svg') }}" class="img-fluid" alt="">
                                </a>
                                <a href="javascript:void(0)" class="category-name">
                                    <h6>Frozen Foods</h6>
                                </a>
                        ...
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/milk.svg') }}" class="img-fluid" alt="">
                                </a>
                                <a href="javascript:void(0)" class="category-name">
                                    <h6>Milk & Dairies</h6>
                                </a>
                        ...
                        <div>
                            <div class="dashboard-category">
                                <a href="javascript:void(0)" class="category-image">
                                    <img src="{{ url('assets/backend/svg/pet.svg') }}" class="img-fluid" alt="">
                                </a>
                                <a href="javascript:void(0)" class="category-name">
                                    <h6>Pet Food</h6>
                                </a>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="best-product-box">
                                                <div class="product-image">
                                                    <img src="{{ url('assets/backend/images/product/1.png') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="best-product-box">
                                                <div class="product-image">
                                                    <img src="{{ url('assets/backend/images/product/2.png') }}"
                                                        class="img-fluid" alt="Product">
                                                </div>
                                                <div class="product-name">
                                                    <h5>Aata Buscuit</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="best-product-box">
                                                <div class="product-image">
                                                    <img src="{{ url('assets/backend/images/product/3.png') }}"
                                                        class="img-fluid" alt="Product">
                                                </div>
                                                <div class="product-name">
                                                    <h5>Aata Buscuit</h5>
