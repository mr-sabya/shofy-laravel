                            ...
                            <table id="projects-tbl" class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ url('assets/backend/images/contacts/pic1.jpg') }}" class="avatar avatar-md rounded-circle" alt="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ url('assets/backend/images/contacts/pic2.jpg') }}" class="avatar avatar-md rounded-circle" alt="">
                                                <p class="mb-0 ms-2">Daniel Arran</p>
                                            </div>
                                        </td>
                                        <td>Mobile</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ url('assets/backend/images/contacts/pic3.jpg') }}" class="avatar avatar-md rounded-circle" alt="">
                                                <p class="mb-0 ms-2">Daniel Arran</p>
                                            </div>
                                        </td>
                                        <td>Ac</td>
                            ...
                            <table id="projects-tbl4" class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="products">
                                                <img src="{{ url('assets/backend/images/contacts/d14.jpg') }}" class="avatar avatar-sm" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="products">
                                                <img src="{{ url('assets/backend/images/contacts/d10.jpg') }}" class="avatar avatar-sm" alt="">
                                                <div>
                                                    <h6><a href="javascript:void(0)">Air Conditioner</a></h6>
                                                    <span>24 Apr 2021</span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="products">
                                                <img src="{{ url('assets/backend/images/contacts/d11.jpg') }}" class="avatar avatar-sm" alt="">
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="products">
                                                <img src="{{ url('assets/backend/images/contacts/d12.jpg') }}" class="avatar avatar-sm" alt="">
                                                <div>
                            ...
                            <table id="projects-tbl2" class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="products">
                                                <img src="{{ url('assets/backend/images/contacts/d1.jpg') }}" class="avatar avatar-sm" alt="">
                                                <div>
                                                    <h6><a href="javascript:void(0)">Air Conditioner</a></h6>
                                                    <span>24 Apr 2021</span>
                                                </div>
