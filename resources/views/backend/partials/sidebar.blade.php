        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li class="{{ Route::is('admin.department.index') ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.department.index') }}" class="{{ Route::is('admin.department.index') ? 'mm-active' : '' }}">Department</a>
                    </li>
                    <li class="{{ Route::is('admin.category.index') ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.category.index') }}" class="{{ Route::is('admin.category.index') ? 'mm-active' : '' }}">Category</a>
                    </li>
                    <li class="{{ Route::is('admin.sub-category.index') ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.sub-category.index') }}" class="{{ Route::is('admin.sub-category.index') ? 'mm-active' : '' }}">Sub Category</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li class="{{ Route::is('admin.slider.index') ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.slider.index') }}" class="{{ Route::is('admin.slider.index') ? 'mm-active' : '' }}">Slider</a>
                    </li>
                    <li class="{{ Route::is('admin.small-slider.index') ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.small-slider.index') }}" class="{{ Route::is('admin.small-slider.index') ? 'mm-active' : '' }}">Small Slider</a>
                    </li>
                    <li class="{{ Route::is('admin.sub-category.index') ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.sub-category.index') }}" class="{{ Route::is('admin.sub-category.index') ? 'mm-active' : '' }}">Sub Category</a>
                    </li>
