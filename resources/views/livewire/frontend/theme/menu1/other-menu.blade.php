<header>
    <div class="tp-header-area tp-header-style-primary tp-header-height">
        <!-- header top start  -->
        <livewire:frontend.theme.top-header.header1 wire:key="other-menu-top-header" />
                ...
                <div class="tp-mega-menu-wrapper p-relative">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-5 col-md-5 col-sm-4 col-6">
                            <livewire:frontend.theme.logo.light wire:key="other-menu-logo"/>
                        </div>
                        <div class="col-xl-5 d-none d-xl-block">
                            <div class="main-menu menu-style-2">
                                <nav class="tp-main-menu-content">
                                    <livewire:frontend.theme.menu.menu-item wire:key="other-menu-menu-item" />
                                </nav> 
                            </div>
                            <div class="tp-category-menu-wrapper d-none">
                                <nav class="tp-category-menu-content">
                                    <livewire:frontend.theme.menu.category wire:key="other-menu-category" />
                                </nav>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-7 col-md-7 col-sm-8 col-6">
                            <div class="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                                ...
                                <div class="tp-header-action d-flex align-items-center ml-30">
                                    <livewire:frontend.theme.menu.action wire:key="other-menu-action" />
                                </div>
                            </div>
                        </div>
                    </div>
