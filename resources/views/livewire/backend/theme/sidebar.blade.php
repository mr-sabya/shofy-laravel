    ...
    <div>
        <div class="logo-wrapper logo-wrapper-center">
            <a href="index.html" data-bs-original-title="" title="">
                <img class="img-fluid for-white" src="{{ url('assets/backend/images/logo/full-white.png') }}" alt="logo">
            </a>
            <div class="back-btn">
        ...
        <div class="logo-icon-wrapper">
            <a href="index.html">
                <img class="img-fluid main-logo main-white" src="{{ url('assets/backend/images/logo/logo.png') }}" alt="logo">
                <img class="img-fluid main-logo main-dark" src="{{ url('assets/backend/images/logo/logo-white.png') }}"
                    alt="logo">
            </a>
        </div>
