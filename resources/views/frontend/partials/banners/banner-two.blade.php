<section class="tp-banner-area {{ $square == true ? 'pb-30' : 'pb-70' }}">
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-lg-7">
                <div class="tp-banner-item tp-banner-height {{ $square == true ? 'has-square' : '' }} p-relative mb-30 z-index-1 fix">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="tp-banner-item tp-banner-item-sm {{ $square == true ? 'has-square' : '' }} tp-banner-height p-relative mb-30 z-index-1 fix">
